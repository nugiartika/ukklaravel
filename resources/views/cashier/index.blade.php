                        ...
                        <div class="d-flex flex-column">
                            ...
                            <div class="chart-statistics">
                                ...
                                <p class="text-success text-nowrap mb-0"><i
                                        class='ti ti-chevron-up me-1'></i> 15.8%</p>
                            </div>
                        </div>
            ...
            <div class="card-body p-0">
                <div class="row row-bordered g-0">
                    <div class="col-md-8 position-relative p-6">
                        <div
                            class="card-header d-inline-block p-0 text-wrap position-absolute">
                    ...
                    <div class="col-md-4 p-4">
                        ...
                        <p class="mb-8 text-center"><span
                                class="fw-medium text-heading">Budget: </span>56,800</p>
                        <div class="px-3">
        ...
        <div class="card h-100">
            <div class="card-header d-flex justify-content-between">
                ...
                <div class="dropdown">
                    <button
                        class="btn btn-text-secondary rounded-pill text-muted border-0 p-2 me-n1"
                        type="button" id="transactionID" data-bs-toggle="dropdown"
                        aria-haspopup="true" aria-expanded="false">
                        <i class="ti ti-dots-vertical ti-md text-muted"></i>
                    </button>
                    <div class="dropdown-menu dropdown-menu-end"
